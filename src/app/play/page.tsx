...
export default function PlayPage() {
  ...
  const games = [
    ...
    { id: 4, name: "Pudgy Party", desc: "Mythical Games and Pudgy Penguins are bringing you a cool new mobile royale game with drops, new characters, and rewards for the community.", logo: "/pudgy_party.svg", descImage: "/pudgy_party_desc.avif" },
